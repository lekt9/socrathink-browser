...
export class WindowsService {
  ...
  private hiddenView: BrowserView | null = null;

  public getHiddenView(): BrowserView {
    if (!this.hiddenView || this.hiddenView.webContents.isDestroyed()) {
      this.hiddenView = new BrowserView({
        webPreferences: {
      ...
      this.hiddenView.setAutoResize({ width: true, height: true });
    }

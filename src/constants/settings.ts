...
export const DEFAULT_SEARCH_ENGINES = [
  ...
  {
    name: 'Startpage',
    url: 'https://startpage.com/sp/search?q=%s&segment=startpage.socrathink',
    keywordsUrl: '',
  ...
  {
    name: 'Ekoru',
    url: 'https://www.ekoru.org/?ext=socrathink&q=%s',
    keywordsUrl: 'http://ac.ekoru.org/?ext=socrathink&q=%s',
    keyword: 'ekoru.org',
